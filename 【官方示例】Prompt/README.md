...
1. 挑一个你喜欢的 Prompt，复制全文
2. 粘贴到 **[WorkBuddy](https://www.codebuddy.cn/work/)** / Claude Code / Cursor 等 AI 编程工具
3. AI 会自动生成完整项目（含代码、样式、Edge Functions）
4. 按 AI 的指引部署到 [EdgeOne Pages](https://pages.edgeone.ai/)，通常 3 分钟内可访问
